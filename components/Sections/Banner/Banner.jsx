...
const Banner = () => {
  return (
    <div className='bg-primary'>
      <Container className='md:grid md:grid-cols-3 py-10 md:py-20'>
        <div className='md:col-span-2 flex flex-col px-5 md:px-0'>
          <div>
          ...
          <div className='mt-5 lg:mt-auto flex flex-col gap-3 msm:flex-row msm:gap-10'>
